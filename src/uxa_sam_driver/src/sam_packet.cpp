...
std::shared_ptr<rclcpp::Subscription<uxa_serial_msgs::msg::Receive>> uxa_serial_sub;
std::shared_ptr<rclcpp::Subscription<uxa_sam_msgs::msg::PositionMove>> sam_driver_position_move_sub;
std::shared_ptr<rclcpp::Subscription<uxa_sam_msgs::msg::StdPositionMove>>  sam_driver_std_position_move_sub;
